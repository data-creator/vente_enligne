        ...
        var opt='';
         $.ajax({
            ...
            success:function(data){
                ...
                $('#ville').append('<select class=" form-control" name="couleur[]">'+opt+'</select><input type="text" class="form-control" name="couler_quantiter[]" id="recipient-name">');
         }
                ...
                <div class="menu-desktop">
                    <ul class="main-menu">
                        <li>
                            ...
                            <!-- <ul class="sub-menu"> -->
                                <!-- <li><a href="{{asset('client/index.html')}}">Homepage 1</a></li>
                                <li><a href="{{asset('client/home-02.html')}}">Homepage 2</a></li>
                                <li><a href="{{asset('client/home-03.html')}}">Homepage 3</a></li> -->
                            <!-- </ul> -->
                        </li>
                        ...
                        <li>
                            <a href="{{asset('client/contact.html')}}">Contact</a>
                        </li>
                    </ul>
                </div>
    ...
    <div class="wrap-header-mobile">
        ...
        <div class="logo-mobile">
            <a href="{{asset('client/index.html')}}"><img
                        src="{{asset('client/images/icons/logo-01.png')}}" alt="IMG-LOGO"></a>
        </div>
    ...
    function getproduits() {
        ...
        <div class="w-full">
                ...
                <div class="header-cart-buttons flex-w w-full">
                    ...
                    <a href="{{asset('client/shoping-cart.html')}}"
