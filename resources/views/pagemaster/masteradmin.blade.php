    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">
          ...
          <span>commande et produit </span>
        </a>
        <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Gestion </h6>
            <a class="collapse-item" href="{{url('commande')}}">Gestion commande</a>
            <a class="collapse-item" href="{{url('produit')}}">Gestion produits</a>
            <a class="collapse-item" href="{{url('univer')}}">Gestion univer</a>
            <a class="collapse-item" href="{{url('soustype')}}">Gestion sous type</a>
            <a class="collapse-item" href="{{url('type')}}">Gestion type</a>
            <a class="collapse-item" href="{{url('couleur')}}">Gestion couleur</a>
      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="{{url('ville')}}">Gestion ville</a>
            <a class="collapse-item" href="{{url('pay')}}">Gestion pays</a>
            <a class="collapse-item" href="{{url('produit')}}">Gestion client</a>
          </div>
        </div>
      </li>
